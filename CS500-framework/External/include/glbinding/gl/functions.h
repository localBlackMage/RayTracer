...
GLBINDING_API void glClearNamedFramebufferfi(GLuint framebuffer, GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
...
GLBINDING_API void glMatrixRotatedEXT(GLenum mode, GLdouble m_fAngle, GLdouble x, GLdouble y, GLdouble z);
GLBINDING_API void glMatrixRotatefEXT(GLenum mode, GLfloat m_fAngle, GLfloat x, GLfloat y, GLfloat z);
...
GLBINDING_API void glRotated(GLdouble m_fAngle, GLdouble x, GLdouble y, GLdouble z);
GLBINDING_API void glRotatef(GLfloat m_fAngle, GLfloat x, GLfloat y, GLfloat z);
GLBINDING_API void glRotatexOES(GLfixed m_fAngle, GLfixed x, GLfixed y, GLfixed z);
